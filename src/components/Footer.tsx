  ...
  return (
    <footer className="py-10 md:py-16 relative">
      ...
      <div className="container mx-auto px-5 md:px-10">
        <div className="flex flex-col lg:flex-row justify-between items-start border-t border-zinc-100 dark:border-zinc-800 pt-10">
          ...
          <div className="mb-8 lg:mb-0 lg:max-w-md">
            <Newsletter
              ...
              description="Get insights, tips, and updates on digital design and development."
              placeholder="Your email address"
              buttonText="Subscribe"
            />
          </div>

          <div className="grid grid-cols-2 gap-x-24 gap-y-8 md:grid-cols-2">
            <div>
