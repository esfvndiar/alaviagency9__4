...
describe("ErrorBoundary", () => {
  ...
  it("should catch an error and render the default fallback UI", () => {
    ...
    expect(
      screen.getByText(/There was an error rendering this component./i),
    ).toBeInTheDocument();
    expect(
      screen.getByText(/Test error from ProblemChild/i),
    ).toBeInTheDocument(); // Check error message is displayed
    expect(
  ...
  it("should render the default fallback UI with componentName prop", () => {
    ...
    expect(
      screen.getByText(
        /There was an error loading the MyComponent component./i,
      ),
    ).toBeInTheDocument();
  });
