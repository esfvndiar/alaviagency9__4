...
const CTASection: React.FC = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 md:py-32 relative bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-950 overflow-hidden"
    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-6 lg:gap-10">
              <div className="lg:col-span-6 text-left">
                <h2 className="text-[6rem] sm:text-[8rem] md:text-[10rem] lg:text-[12rem] xl:text-[14rem] font-display font-bold tracking-tight leading-[0.8] -ml-2 md:-ml-4">
                  <span className="text-lava inline-block dark:text-gradient">
                    HEY!
                  </span>
                </h2>
              </div>
              <div className="lg:col-span-6 text-left lg:pl-0">
                ...
                >
                  ...
                  <ArrowRight
                    className={`transition-transform duration-300 ease-in-out ${isHovered ? "translate-x-2" : ""}`}
                  />
                </a>
              </div>
            </div>
