...
const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 md:py-32 relative bg-white dark:bg-zinc-900 overflow-hidden">
      {/* Background elements */}
                    ...
                    {['Innovative Solutions', 'Client-Focused Approach', 'Technical Excellence', 'Creative Design'].map((item, index) => (
                      <ScrollReveal key={index} animation="fade-up" delay={100 * (index + 1)}>
                        <div className="flex items-start space-x-2">
                          ...
                          <span className="text-zinc-700 dark:text-white">{item}</span>
                        </div>
                      </ScrollReveal>
                    ))}
                  </div>
            ...
            <ScrollReveal animation="fade-left" delay={200}>
              ...
              <div className="mb-6">
                <h2 className="text-3xl md:text-5xl font-display font-medium mb-6 tracking-tight">
                  <span className="inline-block mr-3 text-zinc-900 dark:text-white">About</span>
