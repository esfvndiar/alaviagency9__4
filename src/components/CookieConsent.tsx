...
const CookieConsent: React.FC<CookieConsentProps> = React.memo(
  ({ onAccept, onDecline }) => {
    ...
    const saveConsent = useCallback(
      (consentType: string, settingsData: CookieSettings) => {
        const { cookiesSupported, localStorageSupported } = browserSupport;
          ...
          <div className="bg-white/95 dark:bg-zinc-800/95 backdrop-blur-md rounded-2xl shadow-xl border border-zinc-100 dark:border-zinc-700 overflow-hidden transition-all duration-300">
            <div className="p-5 md:p-6 relative">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-display font-semibold bg-gradient-to-r from-cyberblue to-mintgreen bg-clip-text text-transparent">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-300 mb-5">
                Wir verwenden Cookies für eine optimale Website-Erfahrung.
            ...
            <div className="p-5 md:p-6 relative">
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  <h2 className="text-base font-display font-semibold text-zinc-900 dark:text-white mb-1.5">
                    Wir respektieren Ihre Privatsphäre
                  </h2>
                  <p className="text-sm text-zinc-600 dark:text-zinc-300 mb-4">
                    Diese Website verwendet Cookies, um Ihr Erlebnis zu
                    verbessern. Sie können wählen, welche Cookies Sie zulassen
                    möchten.
                  </p>
                  <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2">
                    <button
