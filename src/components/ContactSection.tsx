...
const ContactSection: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (
      !formData.email.trim() ||
      !validation.email.pattern.test(formData.email)
    ) {
    ...
    if (
      formData.subject &&
      formData.subject.length > validation.subject.maxLength
    ) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        throw new Error(
          response.message || siteConfig.forms.contact.messages.error,
        );
      }
    } catch (error: unknown) {
      setSubmitStatus("error");
                ...
                >
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="mt-2 text-sm text-red-700 dark:text-red-400">
                            {errorMessage ||
                              siteConfig.forms.contact.messages.error}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        minLength={
                          siteConfig.forms.contact.validation.name.minLength
                        }
                        maxLength={
                          siteConfig.forms.contact.validation.name.maxLength
                        }
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      maxLength={
                        siteConfig.forms.contact.validation.subject.maxLength
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      minLength={
                        siteConfig.forms.contact.validation.message.minLength
                      }
                      maxLength={
                        siteConfig.forms.contact.validation.message.maxLength
                      }
                    ></textarea>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a
                        ...
                        className="text-zinc-600 dark:text-zinc-300 hover:text-cyberblue dark:hover:text-cyberblue transition-colors"
                      >
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="text-zinc-500 hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400 transition-colors block transform transition-transform duration-200 ease-in-out hover:scale-110"
                    >
                      <svg
                        className="h-6 w-6"
                        fill="currentColor"
