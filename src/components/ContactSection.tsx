              ...
              <div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6 md:p-8 h-full">
                ...
                <div className="mt-10">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href={siteConfig.social.x} target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400 transition-colors" aria-label="X">
                      <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
