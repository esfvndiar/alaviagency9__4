  ...
  const services = [
    {
      title: "Web Design",
      description:
        "Crafting visually stunning, user-centered interfaces that engage and convert.",
      link: "#contact",
    },
    {
    ...
    },
    {
      title: "Mobile Apps",
      description:
        "Creating intuitive, high-performance applications for iOS and Android.",
      link: "#contact",
    },
    {
      title: "Branding",
      description:
        "Developing cohesive brand identities that resonate with your audience.",
      link: "#contact",
    },
  ];
          ...
          {services.map((service, index) => (
            <ScrollReveal key={index} delay={100 * index} animation="fade-up">
              <div className="group">
                ...
                <h3 className="text-2xl font-display font-medium mb-3 text-zinc-900 dark:text-white">
                  {service.title}
                </h3>
