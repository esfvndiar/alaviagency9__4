...
const SERVICES: Service[] = [
  {
    ...
    description:
      "We help businesses define their digital roadmap and transformation journey with data-driven insights and industry expertise.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    features: [
      {
        ...
        description:
          "Comprehensive planning for your organization's digital evolution.",
      },
      {
        id: 2,
        title: "Competitive Analysis",
        description:
          "In-depth research on market trends and competitor strategies.",
      },
      {
        id: 3,
        title: "Technology Stack Recommendations",
        description:
          "Expert guidance on selecting the right technologies for your goals.",
      },
      {
        id: 4,
        title: "ROI Forecasting",
        description:
          "Data-driven predictions on investment returns for digital initiatives.",
      },
    ],
    color: "blue",
    image:
  ...
  },
  {
    ...
    title: "UX/UI Design",
    description:
      "We create intuitive, engaging, and accessible user experiences that delight users and drive business outcomes.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    features: [
      {
        ...
        description: "Gathering insights directly from your target audience.",
      },
      {
        id: 2,
        title: "Wireframing & Prototyping",
        description:
          "Creating interactive models to visualize and test concepts.",
      },
      {
        id: 3,
        title: "Visual Design",
        description:
          "Crafting beautiful interfaces that align with your brand identity.",
      },
      {
        id: 4,
        title: "Accessibility Compliance",
        description: "Ensuring your digital products are usable by everyone.",
      },
    ],
    color: "purple",
    image:
  ...
  },
  {
    ...
    description:
      "We build high-performance, scalable web applications using cutting-edge technologies and best practices.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    features: [
      ...
      },
      {
        ...
        description: "Developing secure, scalable online shopping experiences.",
      },
      {
        id: 4,
        title: "CMS Implementation",
        description: "Setting up content management systems for easy updates.",
      },
    ],
    color: "green",
    image:
  ...
  },
  {
    ...
    description:
      "We develop native and cross-platform mobile applications that provide seamless experiences across devices.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    features: [
      {
        ...
        description: "Building native applications for both major platforms.",
      },
      {
        id: 2,
        title: "Cross-Platform Solutions",
        description:
          "Developing with React Native or Flutter for multi-platform efficiency.",
      },
      {
        id: 3,
        title: "App Store Optimization",
        description: "Maximizing visibility and downloads in app marketplaces.",
      },
      {
        id: 4,
        title: "Mobile UX Design",
        description: "Creating touch-optimized interfaces for smaller screens.",
      },
    ],
    color: "orange",
    image:
  ...
  },
  {
    ...
    description:
      "We transform raw data into actionable insights that drive strategic decision-making and business growth.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    features: [
      {
        ...
        description: "Creating dashboards and reports for data visualization.",
      },
      {
        id: 2,
        title: "Predictive Analytics",
        description: "Using AI and machine learning to forecast trends.",
      },
      {
        id: 3,
        title: "Data Integration",
        description:
          "Connecting disparate data sources for comprehensive analysis.",
      },
      {
        id: 4,
        title: "Custom Analytics Solutions",
        description:
          "Building tailored data platforms for specific business needs.",
      },
    ],
    color: "red",
    image:
  ...
  },
  {
    ...
    description:
      "We help businesses reach their target audience, build brand awareness, and drive conversions through digital channels.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    features: [
      {
        ...
        description:
          "Improving organic visibility and creating valuable content.",
      },
      {
        id: 2,
        title: "Paid Advertising",
        description:
          "Managing PPC campaigns across search and social platforms.",
      },
      {
        id: 3,
        title: "Social Media Marketing",
        description:
          "Building brand presence and engagement on social channels.",
      },
      {
        id: 4,
        title: "Email Marketing",
        description: "Designing and executing targeted email campaigns.",
      },
    ],
    color: "yellow",
    image:
      "https://images.unsplash.com/photo-1432888622747-4eb9a8f5a70d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
  },
];
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const scrolledPercentage = Math.min(
        100,
        Math.max(0, (scrollContainer.scrollLeft / scrollableWidth) * 100),
      );
      ...
      <section className="pt-32 pb-20 overflow-hidden">
        <div className="container mx-auto px-6">
          <ScrollReveal>
            <div className="max-w-5xl mx-auto mb-24">
              <h1 className="font-space-grotesk text-6xl md:text-7xl font-medium mb-8 leading-tight text-zinc-900 dark:text-white">
                Innovative <span className="text-gradient">services</span> to
                transform your digital presence
              </h1>
              <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-300 max-w-3xl">
                We offer a comprehensive range of digital solutions designed to
                        ...
                        >
                          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl mb-6">
                            {service.image ? (
                              ...
                              <div
                                className={`w-full h-full bg-gradient-to-br ${getGradientClass(service.color)}`}
                              ></div>
                            )}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                            <div
                              className={`absolute top-4 left-4 w-10 h-10 rounded-lg flex items-center justify-center ${getIconColorClass(service.color)}`}
                            >
                              {service.icon}
                            </div>
                          </div>
                ...
                <div key={service.id} className="max-w-5xl mx-auto mb-20">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <ScrollReveal>
                      <div>
                        <div
                          className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 ${getIconColorClass(service.color)}`}
                        >
                          {service.icon}
                        </div>
                        <h2 className="font-space-grotesk text-3xl md:text-4xl font-medium mb-4 text-zinc-900 dark:text-white">
                          {service.title}
                        </h2>
                        ...
                        <ul className="space-y-4 mb-8">
                          {service.features.map((feature) => (
                            <li key={feature.id} className="flex items-start">
                              <div
                                className={`mt-1 mr-3 p-1 rounded-full ${getIconColorClass(service.color)}`}
                              >
                    ...
                    <ScrollReveal delay={200}>
                      <div className="bg-gradient-to-br from-zinc-100 dark:from-zinc-800 to-zinc-200 dark:to-zinc-700 rounded-3xl p-8 h-full relative overflow-hidden">
                        <div
                          className={`absolute top-0 left-0 w-full h-2 bg-gradient-to-r ${getGradientClass(service.color)}`}
                        ></div>
                        ...
                        <div className="aspect-square rounded-2xl bg-white dark:bg-zinc-800 shadow-sm flex items-center justify-center overflow-hidden">
                          <img
                            src={
                              service.image ||
                              `https://images.unsplash.com/photo-1581291518633-3f44a563fa4c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80`
                            }
                            alt={service.title}
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              <h2 className="font-space-grotesk text-3xl font-medium mb-12 text-center text-zinc-900 dark:text-white">
                All Services
              </h2>
            </ScrollReveal>
                  ...
                  <div className="border border-zinc-200 dark:border-zinc-700 rounded-xl overflow-hidden">
                    ...
                    >
                      <div className="flex items-center">
                        <div
                          className={`w-10 h-10 rounded-lg flex items-center justify-center mr-4 ${getIconColorClass(service.color)}`}
                        >
                          {service.icon}
                        </div>
                      ...
                      <div className="p-6 pt-0 bg-white dark:bg-zinc-800">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {service.features.map((feature) => (
                            <div
                              key={feature.id}
                              className={`p-4 rounded-lg border ${getColorClass(service.color)}`}
                            >
