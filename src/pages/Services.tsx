      ...
      <section className="pt-32 pb-20 overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          <div className="relative mb-32" ref={serviceRef}>
            ...
            <div className="flex overflow-x-auto pb-8 hide-scrollbar snap-x snap-mandatory">
              <div className="flex space-x-6">
                {SERVICES.map((service, index) => (
                  <ScrollReveal key={service.id} delay={index * 100}>
                    <div 
                      className="w-[350px] flex-shrink-0 snap-center group"
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-zinc-600 line-clamp-2">{service.description}</p>
                      </a>
                    </div>
                  </ScrollReveal>
                ))}
            ...
            <div className="absolute left-0 bottom-0 w-full h-[1px] bg-zinc-200">
              <div 
                className="h-[3px] bg-zinc-900 transition-all duration-1000 ease-in-out"
                style={{ 
          ...
          <div className="mb-12 flex justify-center">
            <ScrollReveal>
              <div className="inline-flex flex-wrap justify-center gap-2 p-1 bg-zinc-100 rounded-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <ScrollReveal>
                    <div>
                      ...
                      <h2 className="font-space-grotesk text-3xl md:text-4xl font-medium mb-4">{service.title}</h2>
                      ...
                      <a 
                        href="/contact" 
                        className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-zinc-900 rounded-full hover:bg-zinc-800 transition-all duration-300 hover:shadow-lg hover:scale-105"
                      >
                  ...
                  <ScrollReveal delay={200}>
                    <div className="bg-gradient-to-br from-zinc-100 to-zinc-200 rounded-3xl p-8 h-full relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              <h2 className="font-space-grotesk text-3xl font-medium mb-12 text-center">All Services</h2>
            </ScrollReveal>
            
            <div className="space-y-4">
              {SERVICES.map(service => (
                <ScrollReveal key={service.id} delay={(service.id - 1) * 100}>
          ...
          <ScrollReveal>
            <div className="mt-32 max-w-5xl mx-auto text-center">
              <div className="bg-gradient-to-r from-zinc-900 to-zinc-800 rounded-3xl p-16 text-white relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full">
                  <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500 rounded-full opacity-10 -translate-y-1/2 translate-x-1/4"></div>
                  <div className="absolute bottom-0 left-0 w-80 h-80 bg-purple-500 rounded-full opacity-10 translate-y-1/3 -translate-x-1/3"></div>
                </div>
                
                <div className="relative z-10">
                  <h2 className="font-space-grotesk text-3xl md:text-4xl font-medium mb-4">Ready to transform your business?</h2>
                  <p className="text-xl text-zinc-300 mb-8 max-w-2xl mx-auto">
                    Let's discuss how our services can help you achieve your digital goals and drive growth for your organization.
                  </p>
                  <a 
                    href="/contact" 
                    className="inline-flex items-center justify-center px-8 py-4 text-base font-medium text-zinc-900 bg-white rounded-full hover:bg-zinc-100 transition-all duration-300 hover:shadow-lg hover:scale-105"
                  >
