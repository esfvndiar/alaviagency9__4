...
const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1600486913747-55e5470d6f40?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    social: {
      linkedin: "https://linkedin.com",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1607746882042-944635dfe10e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    social: {
      linkedin: "https://linkedin.com",
      github: "https://github.com",
    },
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    social: {
      linkedin: "https://linkedin.com",
      twitter: "https://twitter.com",
    },
            ...
            <div className="max-w-4xl mx-auto">
              <h1 className="text-fluid-3xl font-display font-bold mb-6 text-center relative">
                <span className="inline-block relative">
                  <span className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 bg-clip-text text-transparent blur-xl opacity-50">
                    About ALAVI
                  </span>
                  <span className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 bg-clip-text text-transparent">
                    About ALAVI
                  </span>
                </span>
              </h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-fluid-base text-zinc-700 dark:text-zinc-300 mb-6 leading-relaxed">
                  At ALAVI, we believe in the power of technology to transform
                  businesses and enhance lives. Our mission is to create digital
                  solutions that are not only visually stunning but also
                  intuitive, accessible, and impactful.
                </p>
                <p className="text-fluid-base text-zinc-700 dark:text-zinc-300 leading-relaxed">
                  We combine strategic thinking with technical expertise to
                  deliver results that exceed expectations. Whether you're a
                  startup looking to make your mark or an established brand
                  seeking digital transformation, we're here to help you
                  succeed.
                </p>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-fluid-base text-zinc-700 dark:text-zinc-300 max-w-2xl mx-auto">
                ...
                with clients to how we build our products.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {VALUES.map((value) => (
                ...
                >
                  ...
                  <h3 className="text-2xl font-medium mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                    {value.title}
                  </h3>
        ...
        <section className="container mx-auto px-4 sm:px-6 py-16 md:py-24 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-fluid-base text-zinc-700 dark:text-zinc-300 max-w-2xl mx-auto">
                We're a diverse group of creative thinkers, problem solvers, and
                      ...
                      >
                        ...
                        <div className="p-6 flex-grow flex flex-col transition-all duration-500 ease-in-out group-hover:bg-blue-50 dark:group-hover:bg-blue-900/10 relative z-10">
                          <div className="flex items-center justify-between mb-2">
                            <h3 className="text-xl font-medium group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors duration-300">
                              {member.name}
                            </h3>
                            <span className="text-xs font-medium px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full group-hover:bg-blue-200 dark:group-hover:bg-blue-800/30 transition-colors duration-300 ease-in-out">
                              {member.specialty}
                            </span>
                          </div>
                          <p className="text-blue-600 dark:text-blue-400 mb-4 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors duration-300 ease-in-out">
                            {member.role}
                          </p>
