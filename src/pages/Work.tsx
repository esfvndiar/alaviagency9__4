...
const PROJECTS: Project[] = [
  {
    ...
    description: "A comprehensive platform that streamlined operations for a Fortune 500 company, resulting in 35% increased efficiency.",
  ...
  },
  {
    ...
    description: "Complete overhaul of an e-commerce platform that increased conversion rates by 28% and improved user satisfaction.",
    category: "UX/UI Design",
    image: "https://images.unsplash.com/photo-1523726491678-bf852e717f6a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
  ...
  },
  {
    ...
    description: "An intelligent analytics platform that provides real-time insights and predictive analysis for business decision-making.",
  ...
  },
  {
    ...
    description: "A secure, intuitive mobile banking application that revolutionized how customers interact with their finances.",
    category: "Mobile App",
  ...
  },
  {
    ...
    description: "An integrated system that improved patient care coordination and reduced administrative overhead by 40%.",
  ...
  },
  {
    ...
    description: "A platform that helps organizations monitor and optimize their energy usage, promoting sustainability and cost savings.",
          ...
          <ScrollReveal>
            <div className="max-w-5xl mx-auto mb-24">
              <h1 className="font-space-grotesk text-6xl md:text-7xl font-medium mb-8 leading-tight">
                Crafting digital <span className="text-gradient">experiences</span> that inspire and engage
              </h1>
              <p className="text-xl md:text-2xl text-zinc-600 max-w-3xl">
                Explore our portfolio of innovative solutions that have transformed businesses and delighted users across industries.
              </p>
            </div>
          </ScrollReveal>
                    ...
                    >
                      ...
                      <div className="mt-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-sm font-medium text-zinc-500">{project.category}</span>
                        </div>
                        <h3 className="text-2xl font-medium mb-2 group-hover:text-gradient transition-colors duration-300">{project.title}</h3>
              ...
              {filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <h3 className="text-xl font-medium mb-2 group-hover:text-gradient transition-colors duration-300">{project.title}</h3>
